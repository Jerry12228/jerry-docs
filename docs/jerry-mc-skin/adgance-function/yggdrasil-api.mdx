...
## 地址  
```
https://account.mc.jerry.ink/api/yggdrasil
```  
:::tip  
本站已在全站启用 authlib-injector 的 API 地址指示（ALI）功能。
在使用支持 ALI 的 authlib-injector 和启动器时，输入Jerry - MC皮肤站任意页面的地址即可被识别。
e.g. https://accoutn.mc.jerry.ink/
:::  

## 文档  
[Yggdrasil API](https://github.com/yushijinhun/authlib-injector/wiki/Yggdrasil%E6%9C%8D%E5%8A%A1%E7%AB%AF%E6%8A%80%E6%9C%AF%E8%A7%84%E8%8C%83)

## Authlib Injector  
:::info  
本部分搬运于[Authlib Injector](https://blessing.netlify.app/yggdrasil-api/authlib-injector.html)
:::
